...
public class Matrix
{
	...
	public Matrix initRotation(Vector3D forward, Vector3D up)
	{
	...
	public Matrix initRotation(Vector3D forward, Vector3D up, Vector3D right)
	{
		Vector3D f = forward;
		Vector3D r = right;
		Vector3D u = up;
	...
	{
		return new Vector3D(m[0][0] * r.getX() + m[0][1] * r.getY() + m[0][2] * r.getZ() + m[0][3],
